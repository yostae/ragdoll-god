...
export const MATERIAL_ORDER = ['dirt', 'wood', 'stone', 'brick', 'iron', 'sand', 'ice', 'bouncy'];
...
export const ITEM_ORDER = ['bonkHammer', 'growWand', 'shrinkWand', 'transmuteWand', 'feather'];
...
export const DECOR_ORDER = ['tree', 'pine', 'bush', 'flower', 'rock', 'cloud', 'sun', 'castle'];
